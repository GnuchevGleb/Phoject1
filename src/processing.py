...
def filter_by_state(dictionaries_list: list[dict[str, Any]], states: str = "EXECUTED") -> list[dict[str, Any]]:
    """
...
def sort_by_date(dictionaries_list: list[dict[str, Any]], reverse: bool = True) -> Any:
    """
