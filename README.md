...
log
    ...
    Функция декоратор принимает на фходе вункцию и фычисляет время её выполнения. в зависимости от ввода записывает
    в файл или выводит в консоль   время вызова, имя функции, передаваемые аргументы, результат выполнения.

# Тестирование
    Тестами покрыто 87% кода. Все тесты завершаются ожидаемым образом
# Проверка линтерами Flake8 и mypy
    Линтеры Flake8  находят 4 ошибки в функциональном коде
